...
class Detect(Function):
    ...
    def forward(self, loc_data, conf_data, dbox_list):
        """
        loc_data: [batch_num, 8372, 4]
        conf_data: [batch_num, 8372, num_classes]
        dbox_list: [8372, 4]
        """
...
if __name__ == '__main__':
    # vgg_test = make_vgg()
    # print(vgg_test)
    # extras_test = make_vgg()
    # print(extras_test)

    # net = L2Norm(input_channels=3)
    # dummy_input = torch.ones([1, 3, 28, 28])
    # net(dummy_input)
    ...
    loc, conf, dbox = ssd_test(dummy_input)
    print(loc.size())
    print(conf.size())
    print(dbox.size())